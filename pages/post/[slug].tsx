        ...
        {submitted ? (
          <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
            <h3 className="text3xl font-bold">
              Thank you for submiting you comment!
            </h3>
          ...
          >
            <h3 className="text-sm text-yellow-500">Enjoyed the Form</h3>
            ...
            focus:outline-nonr text-white font-bold py-2 px-4 rouded cursor-pointer"
              type="submit"
            />
          </form>
        )}
...
//Trae la informacion e cada una para pintarla
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, //Despues de 60 segundos hace update del cache.
  };
};
